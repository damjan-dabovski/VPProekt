...
namespace SSE
{
    ...
    public class GameState : State
    {
        ...
        public GameState(Game game, int width, int height)
        {
            ...
            this.p1Score.Size = new Size(250, 50);
            ...
            this.p2Score.Size = new Size(250, 50);
            ...
            this.activePlayerReminder.Font = new Font(Form1.font.Families[0], 30, FontStyle.Regular);
        ...
        public void draw(Graphics g)
        {
            ...
            g.FillRectangle(new SolidBrush(game.activePlayer.color), new Rectangle(new Point(activePlayerReminder.Location.X - (activePlayerReminder.Height + 10), activePlayerReminder.Location.Y), new Size(activePlayerReminder.Height, activePlayerReminder.Height)));
